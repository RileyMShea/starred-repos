...
export type StuffQueryVariables = Exact<{ [key: string]: never; }>;


export type StuffQuery = (
  { __typename?: 'Query' }
  & { user?: Maybe<(
    { __typename?: 'User' }
    ...
    & { starredRepositories: (
      ...
      & { nodes?: Maybe<Array<Maybe<(
        { __typename?: 'Repository' }
        & Pick<Repository, 'name' | 'description' | 'url' | 'homepageUrl' | 'stargazerCount' | 'createdAt'>
        & { latestRelease?: Maybe<(
          { __typename?: 'Release' }
          & Pick<Release, 'publishedAt'>
          ...
          & { target?: Maybe<{ __typename?: 'Blob' } | (
            ...
            & { history: (
              { __typename?: 'CommitHistoryConnection' }
              & { commits: CommitHistoryConnection['totalCount'] }
            ) }
 ...
 * __useStuffQuery__
 *
 * To run a query within a React component, call `useStuffQuery` and pass it any options that fit your needs.
 * When your component renders, `useStuffQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useStuffQuery({
 *   variables: {
 *   },
 * });
 */
export function useStuffQuery(baseOptions?: Apollo.QueryHookOptions<StuffQuery, StuffQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<StuffQuery, StuffQueryVariables>(StuffDocument, options);
      }
export function useStuffLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<StuffQuery, StuffQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<StuffQuery, StuffQueryVariables>(StuffDocument, options);
        }
export type StuffQueryHookResult = ReturnType<typeof useStuffQuery>;
export type StuffLazyQueryHookResult = ReturnType<typeof useStuffLazyQuery>;
export type StuffQueryResult = Apollo.QueryResult<StuffQuery, StuffQueryVariables>;